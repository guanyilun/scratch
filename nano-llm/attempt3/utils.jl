...
function gpt2_from_tf_ckpt(tf_checkpoint_path)
    ...
    wte = Dense(permutedims(tf.train.load_variable(tf_checkpoint_path, "model/wte"), (2, 1))) # [n_embed, n_vocab]
    wpe = Dense(permutedims(tf.train.load_variable(tf_checkpoint_path, "model/wpe"), (2, 1))) # [n_embed, ctx_len]
